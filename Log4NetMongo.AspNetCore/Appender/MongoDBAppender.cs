...
namespace Log4NetMongo.AspNetCore.Appender
{
    public class MongoDBAppender : AppenderSkeleton
    {
        ...
        {
            var connectionStringSetting = AppConfiguration.GetConnectionString(ConnectionStringName);
            return !string.IsNullOrWhiteSpace(connectionStringSetting) ? connectionStringSetting : ConnectionString;
        }
